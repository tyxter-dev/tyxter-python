...
| Full local gate | Each accepted section or correction | `1 / 1` per acceptance round | proven — baseline gate passed | 24 | It is local; each public slice can invalidate typing, conformance, or packaging |
