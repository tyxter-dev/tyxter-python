...
- [x] One dedicated successor draft PR has green exact-head CI on Python 3.10–3.13 and safely
...
- [x] Goal 3 exact-head Python 3.10–3.13 CI passes on successor draft PR
      https://github.com/tyxter-dev/tyxter-python/pull/3; required checks resolve against its current head.
- [x] PR #2 is linked and closed only after the successor safely contains its exact artifacts.
- [x] No merge, tag, workflow dispatch, or PyPI publication occurs.
- [x] Every budgeted gate records actual runs; no lifecycle-gate overrun occurred.
